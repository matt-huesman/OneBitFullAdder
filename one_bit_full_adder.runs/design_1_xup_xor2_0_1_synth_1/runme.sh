...
HD_PWD='Z:/Documents/Projects/vivado/one_bit_full_adder/one_bit_full_adder.runs/design_1_xup_xor2_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_xup_xor2_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_xup_xor2_0_1.tcl
